...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="page-header text-center">
            <h1 style="font-size: x-large; font-family: 'Times New Roman', Times, serif; font: bold;">Registro de Articulos</h1>
            <br />
        </div>
        <br />
        ...
        <div class="row">
            ...
            <div class="offset-md-4 offset-sm-4 col-xs-12 col-sm-4 col-md-4 col-lg-2 ">
        ...
        <div class="row">
            <div class="col-xs-12 col-ms-4 col-md-3 col-lg-8">
